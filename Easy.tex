...
\begin{document}
	...
	\afterpage{%
		...
		\begin{code}	
			...
			CHS ConAgra Cargill is looking for agricultural laborers to help meet the world's food needs.
		\end{code}

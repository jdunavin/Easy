...
\begin{document}
	...
	\afterpage{%
		...
		\begin{code}	
			...
			\noindent This position sorts, trims, and inspects potatoes for defects to minimize waste of any usable food products. Performs other duties as assigned such as, but not limited to: Sanitation work, heavy labor to include lifting up to 50lbs, inspecting for foreign materials, recasing product, and housekeeping.
			...
			\begin{itemize}
				...
				\item Must be able to work in different environments and situations to accomplish production goals for private interests, government contracts, and support the Food Security Treaty of 2027.
			\end{itemize}
			...
			\begin{itemize}
				...
				\item Must be available for both scheduled and unscheduled overtime, especially around inspections and deadlines for government / treaty inspections.
			\end{itemize}
	...
	Aiden slumped onto his bed, covering his face with his hands.  rubbed his face and eyes a bit, and brought his head up to rest his chin in his hands. ``The farms. It's the only way. Otherwise my family -- my sister -- will get hounded by Department of Education collectors. Hounded out of their home... Oh my God..." He broke down sobbing.
		
	``You've ... got ... \textit{skills}." Chandler seemed to think that Aiden could take a binder labelled SKILLS with him to the plant and that it would guarantee him a cushy office job from which to manage his data-cleaning contracts, art projects, and the coordination of advertising for his foodie blog. ``You could get promoted pretty quickly."

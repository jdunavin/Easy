	...
	\vspace*{\fill}
		...
		\begin{code}	
			\begin{tabbing}
				...
				SEARCHING FOR CMS PATIENT CLOUD\dots DONE \\
				\dots \\
				0007 \> PROTOCOL INITIATED \\
				0008 \> CHECKING SHIBBOLETH \dots DONE \\
				0009 \> PATIENT:  MARKSON, AIDEN DANIEL \\
				0010 \> DOB: 48296.6509606481 \\
				0011 \> STATUS UPDATE ID=0085746212857132 \\
				STATUS UPDATE 0085746212857132 IN PROGRESS \dots \\
				...
				1380 \> this.Patient.prem = this.Patient.prem + \\ surchargeSched.diagCode("I10") \\
					 \> \dots
				1381 \} \\
				1382 \> msg -> "STG1 HYPERTENSION NOT MANAGED\dots \\
					 \> SHARED RESPONSIBILITY PAYMENT APPLIED" \\
				CHECKING EMPLOYMENT RECORDS\dots
			\end{tabbing}
		\end{code}
...
\afterpage{%
	...
	\begin{code}	
		...
		\begin{center}
			\LARGE CHS ConAgra Cargill is hiring! \\
			\Large Need work?	
		\end{center}
		
		\vspace{0.5cm}
		
		\noindent CHS ConAgra Cargill is looking for agricultural laborers to help meet the world's food needs.
		
		\vspace{0.5cm}
		
		\noindent This position sorts, trims, and inspects potatoes for \\
		defects to minimize waste of any usable food products. \\ Performs other duties as assigned such as, but not \\
		limited to: Sanitation work, heavy labor to include \\
		lifting up to 50lbs, inspecting for foreign materials, \\ recasing product, and housekeeping.
		
		\vspace{0.5cm}
		
		\noindent Position Responsibilities
		
		\begin{itemize}
			\item Must be able to work safely in a plant environment.
			\item Must be able to work within quality policies and \\ procedures under Food Security Treaty provisions.
			\item Must be able to work in different environments and \\ 
			situations to accomplish production goals for private \\ interests, government contracts, and to support the \\
			Food Security Treaty of 2027.
		\end{itemize}
		
		\noindent Position Qualifications
		
		\begin{itemize}
			\item Must be able to work all three shifts at the plant			
			\item Must be able to wear personal protective equipment as required.
			\item Must be available for both scheduled and unscheduled overtime, especially around deadlines for government / treaty inspections.
		\end{itemize}
		
		\noindent Benefits include competitive pay, savings / student loan contributions, and no nanobot checks. 
	...
	Aiden slumped onto his bed, covering his face with his hands.  rubbed his face and eyes a bit, and brought his head up to rest his chin in his hands. ``The farms. It's the only way. Otherwise my family -- my sister -- will get hounded by Department of Education collectors. Hounded out of their home\dots Oh my God\dots" He broke down sobbing.
		
	``You've\dots got\dots \textit{skills}." Chandler seemed to think that Aiden could take a binder labelled SKILLS with him to the plant and that it would guarantee him a cushy office job from which to manage his data-cleaning contracts, art projects, and the coordination of advertising for his foodie blog. ``You could get promoted pretty quickly."
